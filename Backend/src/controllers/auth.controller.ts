...
export const signup = async (req: Request, res: Response) => {
    const { first_name, last_name, email, mobile_number, otp } = req.body;
    ...
    try {
        ...
        const newUser = await pool.query(
            'INSERT INTO users (first_name, last_name, email, mobile_number, password) VALUES ($1, $2, $3, $4, $5) RETURNING id, first_name, last_name, email, mobile_number, role',
